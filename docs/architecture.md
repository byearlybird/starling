...
- **`~latestEventstamp`**: The highest eventstamp observed by the store. When merging snapshots, stores forward their clocks to this value to prevent eventstamp collisions across sync boundaries.
...
```typescript
{
  ...
  "~latestEventstamp": "2025-10-26T10:00:00.000Z|0001|a7f2"
}
```
