...
export type TransactionCollectionHandle<T extends AnyObjectSchema> = {
...
export async function executeTransaction<Schemas extends SchemasMap, R>(
	...
	for (const collectionName of Object.keys(
		...
		txHandles[collectionName] = createTransactionHandle(
			idb,
			collectionNameStr,
			config.schema,
			config.getId,
...
function createTransactionHandle<T extends AnyObjectSchema>(
	idb: IDBDatabase,
